...
public class RecentData
{
    ...
    //Timer thresholdCalculationTimer; // moving threshold
    ...
    int thresholdLarge = 50;// 240; //190 // how large must a datapoint be to be considered 'large'
    int thresholdMedium = 5; // UNUSED // how large must a datapoint be to be considered 'medium'
    ...
    class RecentDataCalculation extends TimerTask {
        public void run() {
//        	PApplet.println("RecentData: RecentDataCalculation is DISABLED");
//            int counter = 0;
