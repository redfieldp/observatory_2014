...
public class DataPoint
{
    ...
    long time = 0;// Time should be the time-of-event as reflected in the datafeed (was: System.currentTimeMillis(); )
    ...
    public DataPoint(double originalMagnitude, double magnitude, DataPoint lastBig, DataPoint lastMedium) {
        ...
        if (detailedDebugging) {
        	...
        	PApplet.println("New DataPoint:" + " mag:" + df.format(magnitude) + " time:"+time+ " tempDate:"+tempDate); // + " (" + originalMagnitude + ")" );
        }
    }
